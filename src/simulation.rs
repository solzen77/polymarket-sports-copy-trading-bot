...
pub struct SimulationTracker {
    ...
    log_file: Arc<Mutex<std::fs::File>>, // Main simulation log (simulation.toml)
...
impl SimulationTracker {
    ...
    /// Log to simulation file (same as log_to_file; condition_id/period_timestamp kept for API compatibility)
    pub async fn log_to_market(&self, _condition_id: &str, _period_timestamp: u64, message: &str) {
    ...
    /// Log market start event to simulation.toml
